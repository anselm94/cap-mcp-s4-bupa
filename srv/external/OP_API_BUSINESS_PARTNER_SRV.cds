...
service OP_API_BUSINESS_PARTNER_SRV {
  ...
  entity A_BPContactToAddress {
    ...
    key AddressID                      : String(10) not null;
        ...
        to_BPRelshpCntctPersnEmailAddr : Association to many A_BPContactPersonEmlAddr on to_BPRelshpCntctPersnEmailAddr.RelationshipNumber = RelationshipNumber and to_BPRelshpCntctPersnEmailAddr.BusinessPartnerCompany = BusinessPartnerCompany and to_BPRelshpCntctPersnEmailAddr.BusinessPartnerPerson = BusinessPartnerPerson and to_BPRelshpCntctPersnEmailAddr.ValidityEndDate = ValidityEndDate and to_BPRelshpCntctPersnEmailAddr.AddressID = AddressID;
        to_BPRelshpCntctPersnFaxNumber : Association to many A_BPContactPersonFaxNmbr on to_BPRelshpCntctPersnFaxNumber.RelationshipNumber = RelationshipNumber and to_BPRelshpCntctPersnFaxNumber.BusinessPartnerCompany = BusinessPartnerCompany and to_BPRelshpCntctPersnFaxNumber.BusinessPartnerPerson = BusinessPartnerPerson and to_BPRelshpCntctPersnFaxNumber.ValidityEndDate = ValidityEndDate and to_BPRelshpCntctPersnFaxNumber.AddressID = AddressID;
        to_BPRelshpCntctPersnMblNumber : Association to many A_BPContactPersonMblNmbr on to_BPRelshpCntctPersnMblNumber.RelationshipNumber = RelationshipNumber and to_BPRelshpCntctPersnMblNumber.BusinessPartnerCompany = BusinessPartnerCompany and to_BPRelshpCntctPersnMblNumber.BusinessPartnerPerson = BusinessPartnerPerson and to_BPRelshpCntctPersnMblNumber.ValidityEndDate = ValidityEndDate and to_BPRelshpCntctPersnMblNumber.AddressID = AddressID;
        to_BPRelshpCntctPersnTelNumber : Association to many A_BPContactPersonTelNmbr on to_BPRelshpCntctPersnTelNumber.RelationshipNumber = RelationshipNumber and to_BPRelshpCntctPersnTelNumber.BusinessPartnerCompany = BusinessPartnerCompany and to_BPRelshpCntctPersnTelNumber.BusinessPartnerPerson = BusinessPartnerPerson and to_BPRelshpCntctPersnTelNumber.ValidityEndDate = ValidityEndDate and to_BPRelshpCntctPersnTelNumber.AddressID = AddressID;
        to_BPRelshpCntctPersnWbsteURL  : Association to many A_BPContactPersonWbsteURL on to_BPRelshpCntctPersnWbsteURL.RelationshipNumber = RelationshipNumber and to_BPRelshpCntctPersnWbsteURL.BusinessPartnerCompany = BusinessPartnerCompany and to_BPRelshpCntctPersnWbsteURL.BusinessPartnerPerson = BusinessPartnerPerson and to_BPRelshpCntctPersnWbsteURL.ValidityEndDate = ValidityEndDate and to_BPRelshpCntctPersnWbsteURL.AddressID = AddressID;
        to_EmailAddress                : Association to many A_AddressEmailAddress on to_EmailAddress.AddressID = AddressID and to_EmailAddress.Person = Person;
        to_FaxNumber                   : Association to many A_AddressFaxNumber on to_FaxNumber.AddressID = AddressID and to_FaxNumber.Person = Person;
        to_MobilePhoneNumber           : Association to many A_AddressPhoneNumber on to_MobilePhoneNumber.AddressID = AddressID and to_MobilePhoneNumber.Person = Person;
        to_PhoneNumber                 : Association to many A_AddressPhoneNumber on to_PhoneNumber.AddressID = AddressID and to_PhoneNumber.Person = Person;
        to_URLAddress                  : Association to many A_AddressHomePageURL on to_URLAddress.AddressID = AddressID and to_URLAddress.Person = Person;
  };
  ...
  entity A_BusinessPartner {
    ...
    key BusinessPartner                : String(10) not null;
        ...
        @sap.quickinfo     : 'Company ID of Trading Partner'
        TradingPartner                 : String(6);
        to_BPCreditWorthiness          : Association to A_BPCreditWorthiness on to_BPCreditWorthiness.BusinessPartner = BusinessPartner;
        to_BPDataController            : Association to many A_BPDataController on to_BPDataController.BusinessPartner = BusinessPartner;
        to_BPEmployment                : Association to many A_BPEmployment on to_BPEmployment.BusinessPartner = BusinessPartner;
        to_BPFinServicesReporting      : Association to A_BPFinancialServicesReporting on to_BPFinServicesReporting.BusinessPartner = BusinessPartner;
        to_BPFiscalYearInformation     : Association to many A_BPFiscalYearInformation on to_BPFiscalYearInformation.BusinessPartner = BusinessPartner;
        to_BPRelationship              : Association to many A_BPRelationship on to_BPRelationship.BusinessPartner1 = BusinessPartner;
        to_BPTaxCompliance             : Association to many A_BPTaxCompliance on to_BPTaxCompliance.BusinessPartner = BusinessPartner;
        to_BuPaIdentification          : Association to many A_BuPaIdentification on to_BuPaIdentification.BusinessPartner = BusinessPartner;
        to_BuPaIndustry                : Association to many A_BuPaIndustry on to_BuPaIndustry.BusinessPartner = BusinessPartner;
        to_BusinessPartner             : Association to A_BPFinancialServicesExtn on to_BusinessPartner.BusinessPartner = BusinessPartner;
        to_BusinessPartnerAddress      : Association to many A_BusinessPartnerAddress on to_BusinessPartnerAddress.BusinessPartner = BusinessPartner;
        to_BusinessPartnerAlias        : Association to many A_BusinessPartnerAlias on to_BusinessPartnerAlias.BusinessPartner = BusinessPartner;
        to_BusinessPartnerBank         : Association to many A_BusinessPartnerBank on to_BusinessPartnerBank.BusinessPartner = BusinessPartner;
        to_BusinessPartnerContact      : Association to many A_BusinessPartnerContact on to_BusinessPartnerContact.BusinessPartnerCompany = BusinessPartner;
        to_BusinessPartnerIsBank       : Association to A_BusinessPartnerIsBank on to_BusinessPartnerIsBank.BusinessPartner = BusinessPartner;
        to_BusinessPartnerRating       : Association to many A_BusinessPartnerRating on to_BusinessPartnerRating.BusinessPartner = BusinessPartner;
        to_BusinessPartnerRole         : Association to many A_BusinessPartnerRole on to_BusinessPartnerRole.BusinessPartner = BusinessPartner;
        to_BusinessPartnerTax          : Association to many A_BusinessPartnerTaxNumber on to_BusinessPartnerTax.BusinessPartner = BusinessPartner;
        to_BusPartAddrDepdntTaxNmbr    : Association to many A_BusPartAddrDepdntTaxNmbr on to_BusPartAddrDepdntTaxNmbr.BusinessPartner = BusinessPartner;
        to_Customer                    : Association to A_Customer on to_Customer.Customer = Customer;
        to_PaymentCard                 : Association to many A_BusinessPartnerPaymentCard on to_PaymentCard.BusinessPartner = BusinessPartner;
        to_Supplier                    : Association to A_Supplier on to_Supplier.Supplier = Supplier;
  };
  ...
  entity A_BusinessPartnerAddress {
    ...
    key AddressID                    : String(10) not null;
        ...
        to_AddressUsage              : Association to many A_BuPaAddressUsage on to_AddressUsage.BusinessPartner = BusinessPartner and to_AddressUsage.ValidityEndDate = ValidityEndDate and to_AddressUsage.AddressID = AddressID;
        to_BPAddrDepdntIntlLocNumber : Association to A_BPAddrDepdntIntlLocNumber on to_BPAddrDepdntIntlLocNumber.BusinessPartner = BusinessPartner and to_BPAddrDepdntIntlLocNumber.AddressID = AddressID;
        to_BPIntlAddressVersion      : Association to many A_BPIntlAddressVersion on to_BPIntlAddressVersion.BusinessPartner = BusinessPartner and to_BPIntlAddressVersion.AddressID = AddressID;
        to_EmailAddress              : Association to many A_AddressEmailAddress on to_EmailAddress.AddressID = AddressID and to_EmailAddress.Person = Person;
        to_FaxNumber                 : Association to many A_AddressFaxNumber on to_FaxNumber.AddressID = AddressID and to_FaxNumber.Person = Person;
        to_MobilePhoneNumber         : Association to many A_AddressPhoneNumber on to_MobilePhoneNumber.AddressID = AddressID and to_MobilePhoneNumber.Person = Person;
        to_PhoneNumber               : Association to many A_AddressPhoneNumber on to_PhoneNumber.AddressID = AddressID and to_PhoneNumber.Person = Person;
        to_URLAddress                : Association to many A_AddressHomePageURL on to_URLAddress.AddressID = AddressID and to_URLAddress.Person = Person and to_URLAddress.ValidityStartDate = ValidityStartDate;
  };
  ...
  entity A_BusinessPartnerContact {
    ...
    key ValidityEndDate        : Date not null;
        ...
        @sap.quickinfo     : 'Business Partner Relationship Category'
        RelationshipCategory   : String(6);
        to_ContactAddress      : Association to many A_BPContactToAddress on to_ContactAddress.RelationshipNumber = RelationshipNumber and to_ContactAddress.BusinessPartnerCompany = BusinessPartnerCompany and to_ContactAddress.BusinessPartnerPerson = BusinessPartnerPerson and to_ContactAddress.ValidityEndDate = ValidityEndDate;
        to_ContactRelationship : Association to A_BPContactToFuncAndDept on to_ContactRelationship.RelationshipNumber = RelationshipNumber and to_ContactRelationship.BusinessPartnerCompany = BusinessPartnerCompany and to_ContactRelationship.BusinessPartnerPerson = BusinessPartnerPerson and to_ContactRelationship.ValidityEndDate = ValidityEndDate;
  };
  ...
  entity A_Customer {
    ...
    key Customer                       : String(10) not null;
        ...
        @sap.label         : 'County Code'
        County                         : String(3);
        to_CustAddrDepdntExtIdentifier : Association to many A_CustAddrDepdntExtIdentifier on to_CustAddrDepdntExtIdentifier.Customer = Customer;
        to_CustAddrDepdntInformation   : Association to many A_CustAddrDepdntInformation on to_CustAddrDepdntInformation.Customer = Customer;
        to_CustomerCompany             : Association to many A_CustomerCompany on to_CustomerCompany.Customer = Customer;
        to_CustomerSalesArea           : Association to many A_CustomerSalesArea on to_CustomerSalesArea.Customer = Customer;
        to_CustomerTaxGrouping         : Association to many A_CustomerTaxGrouping on to_CustomerTaxGrouping.Customer = Customer;
        to_CustomerText                : Association to many A_CustomerText on to_CustomerText.Customer = Customer;
        to_CustomerUnloadingPoint      : Association to many A_CustomerUnloadingPoint on to_CustomerUnloadingPoint.Customer = Customer;
        to_CustUnldgPtAddrDepdntInfo   : Association to many A_CustUnldgPtAddrDepdntInfo on to_CustUnldgPtAddrDepdntInfo.Customer = Customer;
  };
  ...
  entity A_CustomerCompany {
    ...
    key CompanyCode                    : String(4) not null;
        ...
        @sap.quickinfo     : 'Customer Account Group'
        CustomerAccountGroup           : String(4);
        to_CompanyText                 : Association to many A_CustomerCompanyText on to_CompanyText.Customer = Customer and to_CompanyText.CompanyCode = CompanyCode;
        to_CustomerDunning             : Association to many A_CustomerDunning on to_CustomerDunning.Customer = Customer and to_CustomerDunning.CompanyCode = CompanyCode;
        to_WithHoldingTax              : Association to many A_CustomerWithHoldingTax on to_WithHoldingTax.Customer = Customer and to_WithHoldingTax.CompanyCode = CompanyCode;
  };
  ...
  entity A_CustomerSalesArea {
    ...
    key Division                       : String(2) not null;
        ...
        @sap.quickinfo     : 'Customer Account Group'
        CustomerAccountGroup           : String(4);
        to_PartnerFunction             : Association to many A_CustSalesPartnerFunc on to_PartnerFunction.Customer = Customer and to_PartnerFunction.SalesOrganization = SalesOrganization and to_PartnerFunction.DistributionChannel = DistributionChannel and to_PartnerFunction.Division = Division;
        to_SalesAreaTax                : Association to many A_CustomerSalesAreaTax on to_SalesAreaTax.Customer = Customer and to_SalesAreaTax.SalesOrganization = SalesOrganization and to_SalesAreaTax.DistributionChannel = DistributionChannel and to_SalesAreaTax.Division = Division;
        to_SalesAreaText               : Association to many A_CustomerSalesAreaText on to_SalesAreaText.Customer = Customer and to_SalesAreaText.SalesOrganization = SalesOrganization and to_SalesAreaText.DistributionChannel = DistributionChannel and to_SalesAreaText.Division = Division;
        to_SlsAreaAddrDepdntInfo       : Association to many A_CustSlsAreaAddrDepdntInfo on to_SlsAreaAddrDepdntInfo.Customer = Customer and to_SlsAreaAddrDepdntInfo.SalesOrganization = SalesOrganization and to_SlsAreaAddrDepdntInfo.DistributionChannel = DistributionChannel and to_SlsAreaAddrDepdntInfo.Division = Division;
  };
  ...
  entity A_CustomerSalesAreaTax {
    ...
    key CustomerTaxCategory       : String(4) not null;
        ...
        to_SlsAreaAddrDepdntTax   : Association to many A_CustSlsAreaAddrDepdntTaxInfo on to_SlsAreaAddrDepdntTax.Customer = Customer and to_SlsAreaAddrDepdntTax.SalesOrganization = SalesOrganization and to_SlsAreaAddrDepdntTax.DistributionChannel = DistributionChannel and to_SlsAreaAddrDepdntTax.Division = Division and to_SlsAreaAddrDepdntTax.DepartureCountry = DepartureCountry and to_SlsAreaAddrDepdntTax.CustomerTaxCategory = CustomerTaxCategory;
  };
  ...
  entity A_Supplier {
    ...
    key Supplier                       : String(10) not null;
        ...
        to_SupplierCompany             : Association to many A_SupplierCompany on to_SupplierCompany.Supplier = Supplier;
        to_SupplierPurchasingOrg       : Association to many A_SupplierPurchasingOrg on to_SupplierPurchasingOrg.Supplier = Supplier;
        to_SupplierText                : Association to many A_SupplierText on to_SupplierText.Supplier = Supplier;
  };
  ...
  entity A_SupplierCompany {
    ...
    key CompanyCode                  : String(4) not null;
        ...
        @sap.quickinfo     : 'Vendor account group'
        SupplierAccountGroup         : String(4);
        to_CompanyText               : Association to many A_SupplierCompanyText on to_CompanyText.Supplier = Supplier and to_CompanyText.CompanyCode = CompanyCode;
        to_Supplier                  : Association to A_Supplier on to_Supplier.Supplier = Supplier;
        to_SupplierDunning           : Association to many A_SupplierDunning on to_SupplierDunning.Supplier = Supplier and to_SupplierDunning.CompanyCode = CompanyCode;
        to_SupplierWithHoldingTax    : Association to many A_SupplierWithHoldingTax on to_SupplierWithHoldingTax.Supplier = Supplier and to_SupplierWithHoldingTax.CompanyCode = CompanyCode;
  };
  ...
  entity A_SupplierPurchasingOrg {
    ...
    key PurchasingOrganization         : String(4) not null;
        ...
        @sap.quickinfo     : 'Vendor account group'
        SupplierAccountGroup           : String(4);
        to_PartnerFunction             : Association to many A_SupplierPartnerFunc on to_PartnerFunction.Supplier = Supplier and to_PartnerFunction.PurchasingOrganization = PurchasingOrganization;
        to_PurchasingOrgText           : Association to many A_SupplierPurchasingOrgText on to_PurchasingOrgText.Supplier = Supplier and to_PurchasingOrgText.PurchasingOrganization = PurchasingOrganization;
  };
